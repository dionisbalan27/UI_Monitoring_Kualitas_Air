...
<?php  //inisialisasi variabel 
    $oksigen_nd2= new ArrayObject(array());//node2
    $suhu_nd2=new ArrayObject(array());
    $ph_nd2=new ArrayObject(array());
     ?>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
    ...
    <a class="dropdown-item" href="<?= site_url('c_monitoring/node4');?>">NODE 4</a>
...
<?php
$oksigen_nd2->append($dat->SENT_NUMBER_1);
$suhu_nd2->append($dat->SENT_NUMBER_2);
$ph_nd2->append($dat->SENT_NUMBER_3);}
?>
	</tbody>
</table>
                  </div>
...
/////////////////// node 2
    ...
    var myLineChart = new Chart(ctxL, {
      ...
      data: {
        ...
        datasets: [{
          label: "Oksigen",
          data: [<?php echo $oksigen_nd2[0]; ?>, <?php echo $oksigen_nd2[1]; ?>, <?php echo $oksigen_nd2[2]; ?>],
          backgroundColor: [
            'rgba(200, 99, 132, 7)',
          ],
          borderColor: [
        ...
        {
          label: "Suhu",
          data: [<?php echo $suhu_nd2[0]; ?>, <?php echo $suhu_nd2[1]; ?>, <?php echo $suhu_nd2[2]; ?>],
          backgroundColor: [
            'rgba(0, 10, 130, .7)',
          ],
          borderColor: [
         ...
         {
          label: "ph",
          data: [<?php echo $ph_nd2[0]; ?>, <?php echo $ph_nd2[1]; ?>, <?php echo $ph_nd2[2]; ?>],
          backgroundColor: [
            'rgba(0, 0, 255, .3)',
          ],
          borderColor: [
